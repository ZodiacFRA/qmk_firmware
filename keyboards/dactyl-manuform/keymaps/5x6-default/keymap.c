                     ...
                     RESET,    _______,
                                        ...
                                        _______,  _______,
                                                                      ...
                                                                      // right hand
                                                                                    ...
                                                                                    KC_MPLY,  _______,  _______,  _______,  _______, TG(_GAMING),
                                                                                                        _______,  RESET,
                                                                      KC_BSPC, LT(_FN, KC_ENTER), 
                                                                      KC_SPC,  KC_A,
                                                                      KC_B, KC_C
),
[_GAMING] = KEYMAP_5x6( // Made for games with non rebindable keymap
  // left hand
   KC_ESC,    KC_1,    KC_2,    KC_3,   KC_4,    KC_5, 
   KC_TAB,    KC_T,    KC_Z,    KC_W,   KC_R,    KC_F,
   KC_LSHIFT, KC_Q,    KC_A,    KC_S,   KC_D,    KC_G,
   KC_LCTRL,  KC_GRV,  KC_LALT, KC_X,   KC_C,    KC_V,
                       KC_BSLS, KC_QUOT,
                                        KC_LGUI, KC_E, 
                                        _______, KC_SPC,
                                        _______, _______,
                                                                      ...
                                                                      // right hand
                                                                                    ...
                                                                                    KC_Y,    KC_U,   KC_I,    KC_O,    KC_P,    KC_EQL,
                                                                                    KC_H,    KC_J,   KC_K,    KC_L,    KC_M,    KC_MINS, 
                                                                                    KC_B,    KC_N,   KC_COMM, KC_DOT,  KC_SLSH, TG(_GAMING),
                                                                                                     KC_LBRC, KC_RBRC,
                                                                      KC_BSPC, LT(_FN, KC_ENTER), 
                                                                      KC_SPC,  KC_A,
                                                                      KC_B, KC_C
